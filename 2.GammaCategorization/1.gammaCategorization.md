...
[⬆️ Voltar ao Sumário](#sumario-de-factories)

Este material foi reorganizado para seguir a mesma ordem da trilha mostrada nas aulas.

Em vez de estudar `Factories` como um bloco único e solto, a ideia aqui é acompanhar o caminho natural do capítulo:

- primeiro entender a **Gamma Categorization**;
- depois enxergar o **Overview** da família de soluções;
- em seguida usar o **Point Example** para sentir a ambiguidade da criação;
- depois avançar para as variações, como **Factory Method**, **Asynchronous Factory Method**, **Inner Factory** e **Abstract Factory**;
- por fim, deixar mapeados exercício, resumo e a conversa com `OCP`.
...
1. **Camada conceitual:** para entender o papel da família `Factory` dentro do mapa GoF.
...
<a id="sumario-de-factories"></a>

## Sumário

- [19. Gamma Categorization](#19-gamma-categorization)
...
- [Referências bibliográficas](#referencias-bibliograficas-de-factories)

---

## 19. Gamma Categorization
...
### 19.2 Onde o Factory entra

`Factory` pertence à família **Creational** porque o problema central dele é de criação. Mas, de novo, não é apenas "criar com new". O foco está em:

- controlar o nascimento de objetos;
- esconder detalhes de instanciação;
- nomear caminhos legítimos de criação;
- desacoplar o cliente de classes concretas quando isso fizer sentido.

### 19.3 Factory responde a qual pergunta?

Uma forma simples de separar os padrões criacionais é esta:

- `Factory` tende a responder melhor a **qual objeto deve nascer e por qual caminho**;
- `Builder` tende a responder melhor a **como esse objeto deve ser montado passo a passo**.

Então, mesmo pertencendo à mesma família criacional, eles atacam dores diferentes.

### 19.4 O que isso prepara para a trilha

Ao longo deste capítulo, o nome `Factories` cobre várias técnicas aparentadas.
...
### 20.3 O que muda ao longo da trilha
...
| Aula | Pergunta principal |
| --- | --- |
| 19. Gamma Categorization | Em que família de problema o Factory se encaixa? |
